...
void Bureaucrat::signForm(Form& n)
{
    ...
    {
        std::cout << "Notice : bureaucrat \"" << this->getName() << "\" cannot sign <" << n.getName() << "> because " << e.what() << std::endl;
    }
}
...
void Bureaucrat::executeForm(Form const & form)
{
    ...
    {
        std::cout << "Notice : bureaucrat \"" << this->getName() << "\" cannot excute <" << form.getName() << "> because " << e.what() << std::endl;
    }
}
